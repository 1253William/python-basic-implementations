...
#We accept inputs for l and w to represent Length and Width
...
##Write a program that computes the grade-point average (GPA) for a university student based on letter grades
